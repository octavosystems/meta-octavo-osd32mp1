...
SRCREV:nvram = "45fe43ad51ad47a0c57ad307db3e87da766bf61e"
...
SRCREV:murata = "52174a18134c7ef4a674ecd9fb68fc6e2bced969"
SRCREV:FORMAT = "linux-firmware-murata"
...
FILES_${PN}-bcm43430:append:stm32mpcommon = " \
...
"
RDEPENDS_${PN}-bcm43430:remove:stm32mpcommon = " ${PN}-cypress-license "
